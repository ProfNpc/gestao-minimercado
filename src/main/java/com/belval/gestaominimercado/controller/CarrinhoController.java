...
//	Carrinho carrinho2;
    ...
    public String adicionarProduto(Model model, @RequestParam int id, ItemCarrinho itemCarrinho) {
		  Carrinho carrinho = carrinhoService.findByStatus("pendente");
		  if(carrinho.getStatusCarrinho().equals("pendente"))
